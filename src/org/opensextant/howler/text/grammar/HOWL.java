...
public class HOWL extends Parser {
  ...
  public static final int ADJECTIVE = 1, BADWORD = 2, COMMON_NOUN = 3, QUOTED_TEXT = 4, OPEN = 5, CLOSE = 6, PERIOD = 7,
      COMMA = 8, NUMBER = 9, INTEGER = 10, DECIMAL = 11, DOES = 12, DASH = 13, HAS = 14, PARTICLE = 15, IS = 16,
      PROPER_NOUN = 17, PREDICATE = 18, AND = 19, ONEOF = 20, OR = 21, BY = 22, ONLY = 23, NO = 24, NOT = 25, A = 26,
      EVERY = 27, EXACT = 28, LESS_THAN = 29, LESS_THAN_OR_EQUAL = 30, MORE_THAN = 31, MORE_THAN_OR_EQUAL = 32,
      DATA_FACET = 33, SOME = 34, THE = 35, SAME_AS = 36, INVERSE_OF = 37, THAT = 38, OBJECT_SCOPE = 39,
      DATA_SCOPE = 40, ANNOTATION_MARKER = 41, ANNOTATION_SPLIT = 42, DATATYPE = 43, ITSELF = 44, TO = 45,
      PREDICATE_CHARACTERISTIC = 46, QUOTE = 47, WORD_TYPE = 48, THING = 49, DATA_VALUE = 50, AMBIG_WORD = 51;
  public static final int RULE_document = 0, RULE_statement = 1, RULE_debug = 2, RULE_factStatementData = 3,
      ...
      RULE_predicateCharacteristicStatement = 13, RULE_predicateRelationStatement = 14, RULE_annotationStatement = 15,
      RULE_declarationStatement = 16, RULE_compoundNounPhrase = 17, RULE_properNounPhrase = 18,
      RULE_nProperSequence = 19, RULE_commonNounPhrase = 20, RULE_adjp = 21, RULE_dataTypeExpression = 22,
      RULE_dataTypeRestriction = 23, RULE_dataFacetExpression = 24, RULE_dataValuePhrase = 25, RULE_dataValue = 26,
      RULE_quant = 27, RULE_quantNumeric = 28, RULE_quantNumericExpression = 29, RULE_predicateExpressionObject = 30,
      RULE_predicateExpressionData = 31, RULE_predicateExpressionAnnotation = 32, RULE_predicateExpressionVerbData = 33,
      RULE_predicateExpression = 34, RULE_predicateExpressionVerb = 35, RULE_predicateExpressionState = 36,
      RULE_predicateExpressionSimple = 37, RULE_predicateExpressionParticle = 38, RULE_predicateExpressionPassive = 39,
      RULE_predicateExpressionNoun = 40, RULE_predicateExpressionSameAs = 41, RULE_predicateExpressionBE = 42,
      ...
      RULE_predicatePhrase = 49, RULE_singlePhraseObject = 50, RULE_singlePhraseData = 51, RULE_catchSet = 52,
      RULE_badSentence = 53, RULE_wordSequence = 54, RULE_declareWordSequence = 55, RULE_debugWordSequence = 56;
  public static final String[] ruleNames = {"document", "statement", "debug", "factStatementData",
      "factStatementObject", "descriptionStatementObject", "descriptionStatementDataType", "domainStatementDataType",
      "domainStatementObject", "domainStatementAnnotation", "rangeStatementDataType", "rangeStatementObject",
      "rangeStatementAnnotation", "predicateCharacteristicStatement", "predicateRelationStatement",
      "annotationStatement", "declarationStatement", "compoundNounPhrase", "properNounPhrase", "nProperSequence",
      "commonNounPhrase", "adjp", "dataTypeExpression", "dataTypeRestriction", "dataFacetExpression", "dataValuePhrase",
      "dataValue", "quant", "quantNumeric", "quantNumericExpression", "predicateExpressionObject",
      "predicateExpressionData", "predicateExpressionAnnotation", "predicateExpressionVerbData", "predicateExpression",
      "predicateExpressionVerb", "predicateExpressionState", "predicateExpressionSimple", "predicateExpressionParticle",
      "predicateExpressionPassive", "predicateExpressionNoun", "predicateExpressionSameAs", "predicateExpressionBE",
      "predicateExpressionDO", "predicateExpressionHAS", "predicate", "predicatePhraseNoun", "predicatePhraseDataType",
      "predicatePhraseDataValue", "predicatePhrase", "singlePhraseObject", "singlePhraseData", "catchSet",
      "badSentence", "wordSequence", "declareWordSequence", "debugWordSequence"};

  private static final String[] _LITERAL_NAMES = {};
  private static final String[] _SYMBOLIC_NAMES = {null, "ADJECTIVE", "BADWORD", "COMMON_NOUN", "QUOTED_TEXT", "OPEN",
      "CLOSE", "PERIOD", "COMMA", "NUMBER", "INTEGER", "DECIMAL", "DOES", "DASH", "HAS", "PARTICLE", "IS",
      "PROPER_NOUN", "PREDICATE", "AND", "ONEOF", "OR", "BY", "ONLY", "NO", "NOT", "A", "EVERY", "EXACT", "LESS_THAN",
      "LESS_THAN_OR_EQUAL", "MORE_THAN", "MORE_THAN_OR_EQUAL", "DATA_FACET", "SOME", "THE", "SAME_AS", "INVERSE_OF",
      "THAT", "OBJECT_SCOPE", "DATA_SCOPE", "ANNOTATION_MARKER", "ANNOTATION_SPLIT", "DATATYPE", "ITSELF", "TO",
      "PREDICATE_CHARACTERISTIC", "QUOTE", "WORD_TYPE", "THING", "DATA_VALUE", "AMBIG_WORD"};
  ...
  public static class DocumentContext extends ParserRuleContext {
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitDocument(this);
      else
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        do {
          ...
          _errHandler.sync(this);
          _la = _input.LA(1);
        } while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADJECTIVE) | (1L << BADWORD) | (1L << COMMON_NOUN)
            | (1L << QUOTED_TEXT) | (1L << OPEN) | (1L << CLOSE) | (1L << PERIOD) | (1L << COMMA) | (1L << NUMBER)
            | (1L << INTEGER) | (1L << DECIMAL) | (1L << DOES) | (1L << DASH) | (1L << HAS) | (1L << PARTICLE)
            | (1L << IS) | (1L << PROPER_NOUN) | (1L << PREDICATE) | (1L << AND) | (1L << ONEOF) | (1L << OR)
            | (1L << BY) | (1L << ONLY) | (1L << NO) | (1L << NOT) | (1L << A) | (1L << EVERY) | (1L << EXACT)
            | (1L << LESS_THAN) | (1L << LESS_THAN_OR_EQUAL) | (1L << MORE_THAN) | (1L << MORE_THAN_OR_EQUAL)
            | (1L << DATA_FACET) | (1L << SOME) | (1L << THE) | (1L << SAME_AS) | (1L << INVERSE_OF) | (1L << THAT)
            | (1L << OBJECT_SCOPE) | (1L << DATA_SCOPE) | (1L << ANNOTATION_MARKER) | (1L << ANNOTATION_SPLIT)
            | (1L << DATATYPE) | (1L << ITSELF) | (1L << TO) | (1L << PREDICATE_CHARACTERISTIC) | (1L << QUOTE)
            | (1L << WORD_TYPE) | (1L << THING) | (1L << DATA_VALUE) | (1L << AMBIG_WORD))) != 0));
      }
  ...
  public static class StatementContext extends ParserRuleContext {
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitStatement(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class DebugContext extends ParserRuleContext {
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitDebug(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class FactStatementDataContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_factStatementData;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitFactStatementData(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class FactStatementObjectContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_factStatementObject;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitFactStatementObject(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class DescriptionStatementObjectContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_descriptionStatementObject;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitDescriptionStatementObject(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class DescriptionStatementDataTypeContext extends ParserRuleContext {
    ...
    public TerminalNode DATATYPE() {
      return getToken(HOWL.DATATYPE, 0);
    }
    public TerminalNode AMBIG_WORD() {
      return getToken(HOWL.AMBIG_WORD, 0);
    }
    ...
    @Override
    public int getRuleIndex() {
      return RULE_descriptionStatementDataType;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitDescriptionStatementDataType(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class DomainStatementDataTypeContext extends ParserRuleContext {
    ...
    public TerminalNode DATA_VALUE() {
      return getToken(HOWL.DATA_VALUE, 0);
    }
    public TerminalNode ONLY() {
      return getToken(HOWL.ONLY, 0);
    }
    public TerminalNode NOT() {
      return getToken(HOWL.NOT, 0);
    }
    public CompoundNounPhraseContext compoundNounPhrase() {
      return getRuleContext(CompoundNounPhraseContext.class, 0);
    }
    ...
    @Override
    public int getRuleIndex() {
      return RULE_domainStatementDataType;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitDomainStatementDataType(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class DomainStatementObjectContext extends ParserRuleContext {
    ...
    public TerminalNode THING() {
      return getToken(HOWL.THING, 0);
    }
    public TerminalNode ONLY() {
      return getToken(HOWL.ONLY, 0);
    }
    ...
    @Override
    public int getRuleIndex() {
      return RULE_domainStatementObject;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitDomainStatementObject(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class DomainStatementAnnotationContext extends ParserRuleContext {
    ...
    public TerminalNode ANNOTATION_MARKER() {
      return getToken(HOWL.ANNOTATION_MARKER, 0);
    }
    public TerminalNode THING() {
      return getToken(HOWL.THING, 0);
    }
    ...
    @Override
    public int getRuleIndex() {
      return RULE_domainStatementAnnotation;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitDomainStatementAnnotation(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class RangeStatementDataTypeContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_rangeStatementDataType;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitRangeStatementDataType(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class RangeStatementObjectContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_rangeStatementObject;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitRangeStatementObject(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class RangeStatementAnnotationContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_rangeStatementAnnotation;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitRangeStatementAnnotation(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PredicateCharacteristicStatementContext extends ParserRuleContext {
    public TerminalNode THE() {
      return getToken(HOWL.THE, 0);
    }
    public WordSequenceContext wordSequence() {
      return getRuleContext(WordSequenceContext.class, 0);
    }
    public TerminalNode WORD_TYPE() {
      return getToken(HOWL.WORD_TYPE, 0);
    }
    public TerminalNode IS() {
      return getToken(HOWL.IS, 0);
    }
    public TerminalNode PREDICATE_CHARACTERISTIC() {
      return getToken(HOWL.PREDICATE_CHARACTERISTIC, 0);
    }
    ...
    @Override
    public int getRuleIndex() {
      return RULE_predicateCharacteristicStatement;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitPredicateCharacteristicStatement(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PredicateRelationStatementContext extends ParserRuleContext {
    ...
    public Token relInv;
    public WordSequenceContext obj;
    public List<TerminalNode> THE() {
      return getTokens(HOWL.THE);
    }
    public TerminalNode THE(int i) {
      return getToken(HOWL.THE, i);
    }
    public List<TerminalNode> WORD_TYPE() {
      return getTokens(HOWL.WORD_TYPE);
    }
    ...
    public TerminalNode SAME_AS() {
      return getToken(HOWL.SAME_AS, 0);
    }
    public TerminalNode INVERSE_OF() {
      return getToken(HOWL.INVERSE_OF, 0);
    }
    ...
    @Override
    public int getRuleIndex() {
      return RULE_predicateRelationStatement;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitPredicateRelationStatement(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class AnnotationStatementContext extends ParserRuleContext {
    ...
    public List<TerminalNode> ANNOTATION_SPLIT() {
      return getTokens(HOWL.ANNOTATION_SPLIT);
    }
    ...
    @Override
    public int getRuleIndex() {
      return RULE_annotationStatement;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitAnnotationStatement(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class DeclarationStatementContext extends ParserRuleContext {
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitDeclarationStatement(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class CompoundNounPhraseContext extends ParserRuleContext {
    ...
    public TerminalNode ONEOF() {
      return getToken(HOWL.ONEOF, 0);
    }
    public List<TerminalNode> OR() {
      return getTokens(HOWL.OR);
    }
    ...
    public TerminalNode ITSELF() {
      return getToken(HOWL.ITSELF, 0);
    }
    public List<TerminalNode> AND() {
      return getTokens(HOWL.AND);
    }
    ...
    @Override
    public int getRuleIndex() {
      return RULE_compoundNounPhrase;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitCompoundNounPhrase(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class ProperNounPhraseContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_properNounPhrase;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitProperNounPhrase(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class NProperSequenceContext extends ParserRuleContext {
    public List<TerminalNode> PROPER_NOUN() {
      return getTokens(HOWL.PROPER_NOUN);
    }
    public TerminalNode PROPER_NOUN(int i) {
      return getToken(HOWL.PROPER_NOUN, i);
    }
    public List<TerminalNode> AMBIG_WORD() {
      return getTokens(HOWL.AMBIG_WORD);
    }
    ...
    @Override
    public int getRuleIndex() {
      return RULE_nProperSequence;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitNProperSequence(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class CommonNounPhraseContext extends ParserRuleContext {
    public TerminalNode COMMON_NOUN() {
      return getToken(HOWL.COMMON_NOUN, 0);
    }
    public TerminalNode ADJECTIVE() {
      return getToken(HOWL.ADJECTIVE, 0);
    }
    public TerminalNode PROPER_NOUN() {
      return getToken(HOWL.PROPER_NOUN, 0);
    }
    public TerminalNode THING() {
      return getToken(HOWL.THING, 0);
    }
    ...
    public List<TerminalNode> THAT() {
      return getTokens(HOWL.THAT);
    }
    ...
    @Override
    public int getRuleIndex() {
      return RULE_commonNounPhrase;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitCommonNounPhrase(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public final CommonNounPhraseContext commonNounPhrase() throws RecognitionException {
    ...
    try {
      ...
      enterOuterAlt(_localctx, 1);
      {
        ...
        _errHandler.sync(this);
        _la = _input.LA(1);
        if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << INTEGER) | (1L << ONLY) | (1L << NO) | (1L << A)
            | (1L << EVERY) | (1L << EXACT) | (1L << LESS_THAN) | (1L << LESS_THAN_OR_EQUAL) | (1L << MORE_THAN)
            | (1L << MORE_THAN_OR_EQUAL) | (1L << SOME) | (1L << THE))) != 0)) {
          {
            setState(296);
            quant();
          }
        ...
        setState(302);
        _la = _input.LA(1);
        if (!((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADJECTIVE) | (1L << COMMON_NOUN) | (1L << PROPER_NOUN)
            | (1L << THING) | (1L << AMBIG_WORD))) != 0))) {
          _errHandler.recoverInline(this);
        } else {
          if (_input.LA(1) == Token.EOF)
            matchedEOF = true;
  ...
  public static class AdjpContext extends ParserRuleContext {
    public List<TerminalNode> COMMON_NOUN() {
      return getTokens(HOWL.COMMON_NOUN);
    }
    ...
    public List<TerminalNode> ADJECTIVE() {
      return getTokens(HOWL.ADJECTIVE);
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitAdjp(this);
      else
        return visitor.visitChildren(this);
    }
  }
            ...
            case 1 : {
              {
                ...
                if (!((((_la) & ~0x3f) == 0 && ((1L << _la)
                    & ((1L << ADJECTIVE) | (1L << COMMON_NOUN) | (1L << PROPER_NOUN) | (1L << AMBIG_WORD))) != 0))) {
                  _errHandler.recoverInline(this);
                } else {
                  if (_input.LA(1) == Token.EOF)
                    matchedEOF = true;
  ...
  public static class DataTypeExpressionContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_dataTypeExpression;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitDataTypeExpression(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class DataTypeRestrictionContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_dataTypeRestriction;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitDataTypeRestriction(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class DataFacetExpressionContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_dataFacetExpression;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitDataFacetExpression(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class DataValuePhraseContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_dataValuePhrase;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitDataValuePhrase(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class DataValueContext extends ParserRuleContext {
    public TerminalNode QUOTED_TEXT() {
      return getToken(HOWL.QUOTED_TEXT, 0);
    }
    public TerminalNode INTEGER() {
      return getToken(HOWL.INTEGER, 0);
    }
    public TerminalNode DECIMAL() {
      return getToken(HOWL.DECIMAL, 0);
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitDataValue(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public final DataValueContext dataValue() throws RecognitionException {
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        _la = _input.LA(1);
        if (!((((_la) & ~0x3f) == 0
            && ((1L << _la) & ((1L << QUOTED_TEXT) | (1L << INTEGER) | (1L << DECIMAL))) != 0))) {
          _errHandler.recoverInline(this);
        } else {
          if (_input.LA(1) == Token.EOF)
            matchedEOF = true;
  ...
  public static class QuantContext extends ParserRuleContext {
    ...
    public TerminalNode EVERY() {
      return getToken(HOWL.EVERY, 0);
    }
    public TerminalNode SOME() {
      return getToken(HOWL.SOME, 0);
    }
    public TerminalNode NO() {
      return getToken(HOWL.NO, 0);
    }
    public TerminalNode ONLY() {
      return getToken(HOWL.ONLY, 0);
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitQuant(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class QuantNumericContext extends ParserRuleContext {
    public TerminalNode EXACT() {
      return getToken(HOWL.EXACT, 0);
    }
    public TerminalNode MORE_THAN() {
      return getToken(HOWL.MORE_THAN, 0);
    }
    public TerminalNode LESS_THAN() {
      return getToken(HOWL.LESS_THAN, 0);
    }
    public TerminalNode MORE_THAN_OR_EQUAL() {
      return getToken(HOWL.MORE_THAN_OR_EQUAL, 0);
    }
    public TerminalNode LESS_THAN_OR_EQUAL() {
      return getToken(HOWL.LESS_THAN_OR_EQUAL, 0);
    }
    ...
    @Override
    public int getRuleIndex() {
      return RULE_quantNumeric;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitQuantNumeric(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public final QuantNumericContext quantNumeric() throws RecognitionException {
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        setState(406);
        _la = _input.LA(1);
        if (!((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << EXACT) | (1L << LESS_THAN) | (1L << LESS_THAN_OR_EQUAL)
            | (1L << MORE_THAN) | (1L << MORE_THAN_OR_EQUAL))) != 0))) {
          _errHandler.recoverInline(this);
        } else {
          if (_input.LA(1) == Token.EOF)
            matchedEOF = true;
  ...
  public static class QuantNumericExpressionContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_quantNumericExpression;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitQuantNumericExpression(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PredicateExpressionObjectContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_predicateExpressionObject;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitPredicateExpressionObject(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PredicateExpressionDataContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_predicateExpressionData;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitPredicateExpressionData(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PredicateExpressionAnnotationContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_predicateExpressionAnnotation;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitPredicateExpressionAnnotation(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PredicateExpressionVerbDataContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_predicateExpressionVerbData;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitPredicateExpressionVerbData(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PredicateExpressionContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_predicateExpression;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitPredicateExpression(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PredicateExpressionVerbContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_predicateExpressionVerb;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitPredicateExpressionVerb(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PredicateExpressionStateContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_predicateExpressionState;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitPredicateExpressionState(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PredicateExpressionSimpleContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_predicateExpressionSimple;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitPredicateExpressionSimple(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PredicateExpressionParticleContext extends ParserRuleContext {
    ...
    public TerminalNode PARTICLE() {
      return getToken(HOWL.PARTICLE, 0);
    }
    public TerminalNode NOT() {
      return getToken(HOWL.NOT, 0);
    }
    ...
    @Override
    public int getRuleIndex() {
      return RULE_predicateExpressionParticle;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitPredicateExpressionParticle(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PredicateExpressionPassiveContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_predicateExpressionPassive;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitPredicateExpressionPassive(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PredicateExpressionNounContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_predicateExpressionNoun;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitPredicateExpressionNoun(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PredicateExpressionSameAsContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_predicateExpressionSameAs;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitPredicateExpressionSameAs(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PredicateExpressionBEContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_predicateExpressionBE;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitPredicateExpressionBE(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PredicateExpressionDOContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_predicateExpressionDO;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitPredicateExpressionDO(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PredicateExpressionHASContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_predicateExpressionHAS;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitPredicateExpressionHAS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PredicateContext extends ParserRuleContext {
    public TerminalNode PREDICATE() {
      return getToken(HOWL.PREDICATE, 0);
    }
    public TerminalNode AMBIG_WORD() {
      return getToken(HOWL.AMBIG_WORD, 0);
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitPredicate(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PredicatePhraseNounContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_predicatePhraseNoun;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitPredicatePhraseNoun(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PredicatePhraseDataTypeContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_predicatePhraseDataType;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitPredicatePhraseDataType(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PredicatePhraseDataValueContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_predicatePhraseDataValue;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitPredicatePhraseDataValue(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PredicatePhraseContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_predicatePhrase;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitPredicatePhrase(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class SinglePhraseObjectContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_singlePhraseObject;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitSinglePhraseObject(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class SinglePhraseDataContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_singlePhraseData;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitSinglePhraseData(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class CatchSetContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_catchSet;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitCatchSet(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class BadSentenceContext extends ParserRuleContext {
    public List<TerminalNode> BADWORD() {
      return getTokens(HOWL.BADWORD);
    }
    ...
    @Override
    public int getRuleIndex() {
      return RULE_badSentence;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitBadSentence(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class WordSequenceContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_wordSequence;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitWordSequence(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class DeclareWordSequenceContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_declareWordSequence;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitDeclareWordSequence(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class DebugWordSequenceContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_debugWordSequence;
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HOWLVisitor)
        return ((HOWLVisitor<? extends T>) visitor).visitDebugWordSequence(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static final String _serializedATN = "\3\u608b\ua72a\u8133\ub9ed\u417c\u3be7\u7786\u5964\3\65\u023c\4\2\t\2"
      ...
      + "--\65\65\4\2\31\31\33\33\4\2\34\34$$\4\2\n\n\27\27\4\2\n\n\25\25\4\2\23"
      + "\23\65\65\7\2\3\3\5\5\23\23\63\63\65\65\6\2\3\3\5\5\23\23\65\65\4\2\20"
      + "\20\22\22\4\2\6\6\f\r\3\2\36\"\4\2\16\16\22\22\4\2\34\34%%\4\2\24\24\65"
      + "\65\3\2\62\62\2\u026c\2z\3\2\2\2\4\u008c\3\2\2\2\6\u0093\3\2\2\2\b\u0095"
      + "\3\2\2\2\n\u0098\3\2\2\2\f\u009b\3\2\2\2\16\u009e\3\2\2\2\20\u00a3\3\2"
      + "\2\2\22\u00a9\3\2\2\2\24\u00af\3\2\2\2\26\u00b6\3\2\2\2\30\u00bc\3\2\2"
      + "\2\32\u00c2\3\2\2\2\34\u00c9\3\2\2\2\36\u00cf\3\2\2\2 \u00e1\3\2\2\2\""
      + "\u00ea\3\2\2\2$\u00ff\3\2\2\2&\u011b\3\2\2\2(\u0123\3\2\2\2*\u0128\3\2"
      + "\2\2,\u013e\3\2\2\2.\u0151\3\2\2\2\60\u016d\3\2\2\2\62\u017d\3\2\2\2\64"
      + "\u0189\3\2\2\2\66\u018d\3\2\2\28\u0196\3\2\2\2:\u0198\3\2\2\2<\u019b\3"
      + "\2\2\2>\u019f\3\2\2\2@\u01a1\3\2\2\2B\u01a3\3\2\2\2D\u01a5\3\2\2\2F\u01a9"
