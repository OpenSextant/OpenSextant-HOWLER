...
public class HOWL extends Parser {
  ...
  public static final int ADJECTIVE = 1, BADWORD = 2, COMMON_NOUN = 3, QUOTED_TEXT = 4, OPEN = 5, CLOSE = 6, PERIOD = 7,
      ...
      PROPER_NOUN = 17, PREDICATE = 18, AND = 19, EXCLUSIVELY = 20, OR = 21, BY = 22, ONLY = 23, NO = 24, NOT = 25,
      A = 26, EVERY = 27, EXACT = 28, LESS_THAN = 29, LESS_THAN_OR_EQUAL = 30, MORE_THAN = 31, MORE_THAN_OR_EQUAL = 32,
      DATA_FACET = 33, SOME = 34, THE = 35, EITHER = 36, BOTH = 37, SAME_AS = 38, INVERSE_OF = 39, THAT = 40,
      OBJECT_SCOPE = 41, DATA_SCOPE = 42, ANNOTATION_MARKER = 43, ANNOTATION_SPLIT = 44, DATATYPE = 45, ITSELF = 46,
      TO = 47, PREDICATE_CHARACTERISTIC = 48, QUOTE = 49, WORD_TYPE = 50, THING = 51, DATA_THING = 52, AMBIG_WORD = 53;
  public static final int RULE_document = 0, RULE_statement = 1, RULE_debug = 2, RULE_factStatementData = 3,
      ...
      RULE_badSentence = 53, RULE_wordSequence = 54, RULE_debugWordSequence = 55;
  ...
  private static final String[] _SYMBOLIC_NAMES = {null, "ADJECTIVE", "BADWORD", "COMMON_NOUN", "QUOTED_TEXT", "OPEN",
      ...
      "PROPER_NOUN", "PREDICATE", "AND", "EXCLUSIVELY", "OR", "BY", "ONLY", "NO", "NOT", "A", "EVERY", "EXACT",
      "LESS_THAN", "LESS_THAN_OR_EQUAL", "MORE_THAN", "MORE_THAN_OR_EQUAL", "DATA_FACET", "SOME", "THE", "EITHER",
      "BOTH", "SAME_AS", "INVERSE_OF", "THAT", "OBJECT_SCOPE", "DATA_SCOPE", "ANNOTATION_MARKER", "ANNOTATION_SPLIT",
      "DATATYPE", "ITSELF", "TO", "PREDICATE_CHARACTERISTIC", "QUOTE", "WORD_TYPE", "THING", "DATA_THING",
      "AMBIG_WORD"};
      ...
      enterOuterAlt(_localctx, 1);
      {
        ...
        do {
          ...
          _la = _input.LA(1);
            ...
            | (1L << IS) | (1L << PROPER_NOUN) | (1L << PREDICATE) | (1L << AND) | (1L << EXCLUSIVELY) | (1L << OR)
            | (1L << BY) | (1L << ONLY) | (1L << NO) | (1L << NOT) | (1L << A) | (1L << EVERY) | (1L << EXACT)
            | (1L << LESS_THAN) | (1L << LESS_THAN_OR_EQUAL) | (1L << MORE_THAN) | (1L << MORE_THAN_OR_EQUAL)
            | (1L << DATA_FACET) | (1L << SOME) | (1L << THE) | (1L << EITHER) | (1L << BOTH) | (1L << SAME_AS)
            | (1L << INVERSE_OF) | (1L << THAT) | (1L << OBJECT_SCOPE) | (1L << DATA_SCOPE) | (1L << ANNOTATION_MARKER)
            | (1L << ANNOTATION_SPLIT) | (1L << DATATYPE) | (1L << ITSELF) | (1L << TO)
            | (1L << PREDICATE_CHARACTERISTIC) | (1L << QUOTE) | (1L << WORD_TYPE) | (1L << THING) | (1L << DATA_THING)
            | (1L << AMBIG_WORD))) != 0));
      }
  ...
  public static class DomainStatementDataTypeContext extends ParserRuleContext {
    ...
    public TerminalNode DATA_THING() {
      return getToken(HOWL.DATA_THING, 0);
    }
  ...
  public static class DomainStatementObjectContext extends ParserRuleContext {
    ...
    public List<TerminalNode> THING() {
      return getTokens(HOWL.THING);
    }
  ...
  public static class CompoundNounPhraseContext extends ParserRuleContext {
    ...
    public TerminalNode EXCLUSIVELY() {
      return getToken(HOWL.EXCLUSIVELY, 0);
    }
    public ProperNounPhraseContext properNounPhrase() {
      return getRuleContext(ProperNounPhraseContext.class, 0);
    }
  ...
  public static final String _serializedATN = "\3\u608b\ua72a\u8133\ub9ed\u417c\u3be7\u7786\u5964\3\67\u0247\4\2\t\2"
